...
#=> _privateAttr or method (conventionally): A private attr only to be accessed internally (but it's
# just a convention as it can be accessed like normal attr).
...
#             username = f'Player_{len(Game.players_list) + 1}'
#         return cls(username)
#
#
